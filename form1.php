    ...
    <div id="cont" class="container">
      <div id="form" class="col-12 order-lg-3 order-sm-2">
        ...
        <?php if ($errors['fio']) {print $messages[1];} ?>
          ...
          <p>Стаж</p><br />
          <label>
            <input type="radio" name="radio-kon" value="0" <?php if($values['radio-kon']=='0') print "checked";?>/>0-2
          </label>
          <label>
            <input type="radio" name="radio-kon" value="1" <?php if($values['radio-kon']=='1') print "checked";?>/>2-4
          </label>
          <label>
            <input type="radio" name="radio-kon" value="2" <?php if($values['radio-kon']=='2') print "checked";?>/>4-6
          </label>
          <label>
            <input type="radio" name="radio-kon" value="3" <?php if($values['radio-kon']=='3') print "checked";?>/>6-8
          </label>
          <label>
            <input type="radio" name="radio-kon" value="4" <?php if($values['radio-kon']=='4') print "checked";?> />8-10
          </label>
          <label>
            <input type="radio" name="radio-kon" value="5" <?php if($values['radio-kon']=='5') print "checked";?> />10-12
          </label>
          ...
          <label>
            <select name="sp-sp[]" multiple=multiple <?php if ($errors['ability']) {print 'class="error"';} ?>>
              <option value="0" <?php if(in_array("0", $ability)) print "selected";?>>Друзья</option>
              <option value="1" <?php if(in_array("1", $ability)) print "selected";?>>Реклама</option>
              <option value="2" <?php if(in_array("2", $ability)) print "selected";?>>Случайным образом</option>
            </select>
          </label>
